...
.PHONY: 2fauth-up 2fauth-reset 2fauth-token 2fauth-preflight 2fauth-preflight-bad-token ui-test-live ui-test-live-ipad watch-e2e-live e2e-live
...
ui-test-live-ipad: 2fauth-reset 2fauth-preflight
	...
	xcodebuild test -project "2FAuth.xcodeproj" -scheme "2FAuth" -destination "$${XCODE_DESTINATION}" \
		...
		-only-testing:2FAuthUITests/TwoFAuthUITests/testLoginScreenUsesFormContainerOnIPad \
		...
		-only-testing:2FAuthUITests/TwoFAuthUITests/testSettingsScreenUsesFormContainerOnIPad
