...
$user->twofaccounts()->createMany([
    ...
    [
        ...
        'digits' => 7,
        'period' => 30,
        'legacy_uri' => 'otpauth://totp/Google:john.doe.18%40gmail.com?secret=KBSWY3DPEHPK3PXQ&issuer=Google&algorithm=SHA256&digits=7',
    ],
    [
        'group_id' => $group->id,
        'otp_type' => 'totp',
        ...
        'digits' => 8,
        'period' => 30,
        'legacy_uri' => 'otpauth://totp/Microsoft:john.doe.62%40outlook.com?secret=LBSWY3DPEHPK3PXR&issuer=Microsoft&algorithm=SHA512&digits=8',
    ],
    [
        'group_id' => $group->id,
        'otp_type' => 'totp',
        ...
        'digits' => 9,
        'period' => 30,
        'legacy_uri' => 'otpauth://totp/PlayStation:john_doe_34?secret=MBSWY3DPEHPK3PXS&issuer=PlayStation&algorithm=MD5&digits=9',
    ],
    [
        'group_id' => $group->id,
        'otp_type' => 'totp',
        ...
        'digits' => 10,
        'period' => 30,
        'legacy_uri' => 'otpauth://totp/Stripe:john.doe.53%40company.com?secret=NBSWY3DPEHPK3PXT&issuer=Stripe&digits=10',
    ],
    [
        'group_id' => $group->id,
        'otp_type' => 'totp',
        'service' => 'Discord',
        'account' => 'john_doe_08',
        'secret' => 'OBSWY3DPEHPK3PXU',
        'algorithm' => 'sha1',
        'digits' => 6,
        'period' => 30,
        'legacy_uri' => 'otpauth://totp/Discord:john_doe_08?secret=OBSWY3DPEHPK3PXU&issuer=Discord',
    ],
    [
        'group_id' => $group->id,
        'otp_type' => 'totp',
        ...
        'secret' => 'PBSWY3DPEHPK3PXV',
        'algorithm' => 'sha1',
        'digits' => 6,
        'period' => 30,
        'legacy_uri' => 'otpauth://totp/Dropbox:john.doe.31%40workmail.com?secret=PBSWY3DPEHPK3PXV&issuer=Dropbox',
    ],
    [
        'group_id' => $group->id,
        'otp_type' => 'totp',
        'service' => 'GitHub',
        'account' => 'john_doe_12',
        'secret' => 'QBSWY3DPEHPK3PXW',
        'algorithm' => 'sha1',
        'digits' => 6,
        'period' => 30,
        'legacy_uri' => 'otpauth://totp/GitHub:john_doe_12?secret=QBSWY3DPEHPK3PXW&issuer=GitHub',
    ],
    [
        'group_id' => $group->id,
        'otp_type' => 'totp',
        'service' => 'Nintendo',
        'account' => 'john_doe_21',
        'secret' => 'RBSWY3DPEHPK3PXX',
        'algorithm' => 'sha1',
        'digits' => 6,
        'period' => 30,
        'legacy_uri' => 'otpauth://totp/Nintendo:john_doe_21?secret=RBSWY3DPEHPK3PXX&issuer=Nintendo',
    ],
    [
        'group_id' => $group->id,
        'otp_type' => 'totp',
        ...
        'secret' => 'SBSWY3DPEHPK3PXY',
        'algorithm' => 'sha1',
        'digits' => 6,
        'period' => 30,
        'legacy_uri' => 'otpauth://totp/Notion:john.doe.14%40proton.me?secret=SBSWY3DPEHPK3PXY&issuer=Notion',
    ],
    [
        'group_id' => $group->id,
        'otp_type' => 'totp',
        'service' => 'Reddit',
        'account' => 'john_doe_27',
        'secret' => 'TBSWY3DPEHPK3PXZ',
        'algorithm' => 'sha1',
        'digits' => 6,
        'period' => 30,
        'legacy_uri' => 'otpauth://totp/Reddit:john_doe_27?secret=TBSWY3DPEHPK3PXZ&issuer=Reddit',
    ],
    [
        'group_id' => $group->id,
        'otp_type' => 'steamtotp',
        'service' => 'Steam',
        'account' => 'john_doe_56',
        'secret' => 'UBSWY3DPEHPK3PX2',
        'algorithm' => 'sha1',
        'digits' => 5,
        'period' => 30,
        'legacy_uri' => 'otpauth://steam/Steam:john_doe_56?secret=UBSWY3DPEHPK3PX2&issuer=Steam',
    ],
]);
PHP
)
